...
@section('title', 'Programmer une Inspection - CNPRI')
            ...
            <form action="/inspections" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <select name="inspectors[]" id="inspectors" multiple placeholder="Sélectionner les inspecteurs..." class="w-full">
                        @foreach($inspectors as $inspector)
                        <option value="{{ $inspector->id }}">{{ $inspector->name }} ({{ $inspector->specialization }})</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Vous pouvez joindre un rapport de mission déjà existant au format PDF.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="site_representative" id="site_representative" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Nom du responsable">
                    </div>
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="site_representative_title">
                            Fonction du représentant
                        </label>
                        <input type="text" name="site_representative_title" id="site_representative_title" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ex: Chef de service">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="summary" id="summary" rows="2" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Introduction succincte..."></textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="methodology" id="methodology" rows="4" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Chronologie et étapes de la mission..."></textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="conclusion" id="conclusion" rows="2" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Conclusion globale..."></textarea>
                </div>

                <div class="flex items-center justify-end space-x-4">
                    <a href="/inspections" class="text-gray-600 hover:text-gray-800 text-sm font-semibold">Annuler</a>
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition">
                        Confirmer la Programmation (Brouillon)
                    </button>
                </div>
            </form>
        </div>
...
<script>
    ...
    new TomSelect("#inspectors",{
        ...
        maxItems: 10, // On laisse un peu de marge au cas où, même si l'utilisateur a dit 6
        persist: false,
        create: false,
